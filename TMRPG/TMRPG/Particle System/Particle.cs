...
namespace LimeWorksV2
{
    class Particle
    {
        ...
        public void Draw(SpriteBatch spriteBatch, int Scale, Vector2 Offset)
        {
            ...
            spriteBatch.Draw(Parent.ParticleSprite, new Rectangle((int)((Position.X - 0.5f * currScale) * Scale + Offset.X), (int)((Position.Y - 0.5f * currScale) * Scale + Offset.Y), (int)(currScale * Scale), (int)(currScale * Scale)), null, currCol, 0, Vector2.Zero, SpriteEffects.None, 0);
        }
    }
}